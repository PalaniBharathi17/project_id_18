...
import "./Login.css"; // Ensure this file contains the improved styling
...
const Login = () => {
  ...
  const handleLogin = (e) => {
    ...
    // Mock login logic
    if (role === "supervisor" && username === "2023UCD5001" && password === "17") {
      navigate("/dashboard");
    } else if (role === "admin" && username === "7376231CD501" && password === "1721") {
      navigate("/admin");
    } else {
  ...
  const handleGoogleLogin = () => {
    setError("Google login feature is under development.");
  };
